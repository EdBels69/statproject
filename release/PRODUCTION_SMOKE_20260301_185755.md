...
- generated_at: 2026-03-01T15:57:55Z
...
======================= 5 passed, 26 warnings in 16.52s ========================
```
...
```bash
cd '/Users/eduardbelskih/Проекты Github/statproject/backend' && python3 -m pytest -q tests/test_api_v2.py::test_model_router_benchmark_snapshot_endpoint tests/test_model_router_benchmark.py::test_benchmark_cli_generates_json_and_markdown
```
...
> vitest run
 ...
 ✓ src/features/copilot/components/benchmarkScoring.test.js (4 tests) 43ms
 ✓ src/lib/api.test.js (16 tests) 124ms
 ✓ src/app/components/AnalyticsChart.test.jsx (2 tests) 107ms
 ✓ src/app/pages/PromptBuilder.test.jsx (1 test) 108ms
 ✓ src/app/pages/Settings.test.jsx (1 test) 119ms
 ✓ src/app/pages/Analyze.test.jsx (2 tests) 247ms
 ✓ src/app/utils/analysisSet.test.js (4 tests) 2ms
 ✓ src/app/components/visualizations/utils.test.js (3 tests) 2ms
 ✓ src/app/pages/pageSizeGuard.test.js (4 tests) 1ms
 ✓ src/features/copilot/CopilotPage.test.jsx (5 tests) 1674ms
   ✓ CopilotPage publication flow > auto-freezes cohort in publication mode and forwards analysis_set_id to execute  685ms
   ✓ CopilotPage publication flow > runs model benchmark against multiple presets from request block  316ms

 Test Files  10 passed (10)
      Tests  42 passed (42)
   Start at  18:58:54
   Duration  3.91s (transform 1.47s, setup 0ms, collect 4.86s, tests 2.43s, environment 6.81s, prepare 942ms)
