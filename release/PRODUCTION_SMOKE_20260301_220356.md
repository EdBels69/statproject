...
- generated_at: 2026-03-01T19:03:56Z
...
======================= 5 passed, 26 warnings in 15.96s ========================
```
...
> vitest run
 ...
 ✓ src/lib/api.test.js (16 tests) 56ms
 ✓ src/app/components/AnalyticsChart.test.jsx (2 tests) 151ms
 ✓ src/app/pages/PromptBuilder.test.jsx (1 test) 86ms
 ✓ src/app/pages/Analyze.test.jsx (2 tests) 183ms
 ✓ src/app/pages/Settings.test.jsx (1 test) 205ms
 ✓ src/features/copilot/components/benchmarkScoring.test.js (4 tests) 7ms
 ✓ src/app/pages/pageSizeGuard.test.js (4 tests) 3ms
 ✓ src/app/components/visualizations/utils.test.js (3 tests) 2ms
 ✓ src/features/copilot/CopilotPage.test.jsx (5 tests) 1657ms
   ✓ CopilotPage publication flow > auto-freezes cohort in publication mode and forwards analysis_set_id to execute  740ms
   ✓ CopilotPage publication flow > downloads release bundle after execute  311ms

 Test Files  10 passed (10)
      Tests  42 passed (42)
   Start at  22:04:56
   Duration  4.08s (transform 1.39s, setup 0ms, collect 4.83s, tests 2.36s, environment 7.78s, prepare 1.08s)
