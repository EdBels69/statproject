...
======================= 5 passed, 26 warnings in 16.17s ========================
```
...
runs_total=2 variants_total=10
coverage_gate=PASS (runs_total=2 min_runs=0)
publication: winner=- share=0.0 n=0
focused: winner=minimax_single share=0.5 n=2
...
> vitest run
 ...
 ✓ src/app/utils/analysisSet.test.js (4 tests) 11ms
 ✓ src/lib/api.test.js (16 tests) 108ms
 ✓ src/app/components/AnalyticsChart.test.jsx (2 tests) 125ms
 ✓ src/app/pages/PromptBuilder.test.jsx (1 test) 64ms
 ✓ src/app/pages/Analyze.test.jsx (2 tests) 228ms
 ✓ src/app/pages/Settings.test.jsx (1 test) 192ms
 ✓ src/features/copilot/components/benchmarkScoring.test.js (4 tests) 5ms
 ✓ src/app/components/visualizations/utils.test.js (3 tests) 3ms
 ✓ src/app/pages/pageSizeGuard.test.js (4 tests) 2ms
 ✓ src/features/copilot/CopilotPage.test.jsx (5 tests) 1600ms
   ✓ CopilotPage publication flow > auto-freezes cohort in publication mode and forwards analysis_set_id to execute  746ms

 Test Files  10 passed (10)
      Tests  42 passed (42)
   Start at  23:12:51
   Duration  3.57s (transform 1.49s, setup 0ms, collect 4.31s, tests 2.34s, environment 7.00s, prepare 1.13s)
