...
- generated_at: 2026-03-01T20:04:35Z
...
======================= 5 passed, 26 warnings in 16.12s ========================
```
...
runs_total=1 variants_total=5
coverage_gate=PASS (runs_total=1 min_runs=0)
publication: winner=- share=0.0 n=0
focused: winner=minimax_single share=1.0 n=1
...
> vitest run
 ...
 ✓ src/app/utils/analysisSet.test.js (4 tests) 9ms
 ✓ src/lib/api.test.js (16 tests) 22ms
 ✓ src/app/pages/PromptBuilder.test.jsx (1 test) 134ms
 ✓ src/app/components/AnalyticsChart.test.jsx (2 tests) 164ms
 ✓ src/app/pages/Settings.test.jsx (1 test) 157ms
 ...
 ✓ src/features/copilot/CopilotPage.test.jsx (5 tests) 1151ms
   ✓ CopilotPage publication flow > auto-freezes cohort in publication mode and forwards analysis_set_id to execute  544ms

 Test Files  10 passed (10)
      Tests  42 passed (42)
   Start at  23:05:34
   Duration  3.38s (transform 1.40s, setup 0ms, collect 4.38s, tests 1.81s, environment 6.84s, prepare 917ms)
