...
- generated_at: 2026-03-01T15:40:53Z
...
======================= 5 passed, 26 warnings in 19.42s ========================
```
...
> vitest run
 ...
 ✓ src/app/utils/analysisSet.test.js (4 tests) 5ms
 ✓ src/lib/api.test.js (16 tests) 50ms
 ✓ src/app/components/AnalyticsChart.test.jsx (2 tests) 89ms
 ✓ src/app/pages/PromptBuilder.test.jsx (1 test) 84ms
 ✓ src/app/pages/Analyze.test.jsx (2 tests) 125ms
 ✓ src/app/pages/Settings.test.jsx (1 test) 182ms
 ✓ src/app/components/visualizations/utils.test.js (3 tests) 3ms
 ✓ src/features/copilot/components/benchmarkScoring.test.js (4 tests) 6ms
 ✓ src/app/pages/pageSizeGuard.test.js (4 tests) 2ms
 ✓ src/features/copilot/CopilotPage.test.jsx (5 tests) 1256ms
   ✓ CopilotPage publication flow > auto-freezes cohort in publication mode and forwards analysis_set_id to execute  558ms

 Test Files  10 passed (10)
      Tests  42 passed (42)
   Start at  18:41:54
   Duration  3.56s (transform 1.53s, setup 0ms, collect 4.61s, tests 1.80s, environment 6.53s, prepare 1.04s)
