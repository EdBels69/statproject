...
def test_canonical_method_aliases():
    ...
    assert _canonical_method_id("bayesian_anova") == "bayes_anova"
    assert _canonical_method_id("bayesian_linear_regression") == "bayes_linear_regression"
    assert _canonical_method_id("bayesian_chi_square") == "bayes_chi_square"
