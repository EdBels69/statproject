...
TEST_KNOWLEDGE: Dict[str, Dict[str, Any]] = {
    ...
    "t_test_welch": {
        "name": "Welch's t-test",
        "name_ru": "t‑тест Уэлча",
        "when_to_use": [
            "2 независимые группы",
            "Дисперсии могут различаться",
            "Нормальность приемлема (или n достаточно большой)"
        ],
        "assumptions": ["normality", "independence"],
        "why_it_works": {
            "junior": "Как обычный t‑тест, но не требует равных дисперсий.",
            "mid": "Использует приближение Саттертуэйта для степеней свободы (df).",
            "senior": "Хороший дефолт вместо Student t‑test при сомнении в равенстве дисперсий."
        },
        "effect_size": "cohens_d",
        "emoji": "📊"
    },
    ...
    "anova_welch": {
        ...
        "assumptions": ["normality", "independence"],
        "why_it_works": {
            "junior": "Как ANOVA, но устойчивее к разным дисперсиям.",
            "mid": "Использует корректировку для неравенства дисперсий и неравных размеров групп.",
            "senior": "Практичный выбор при гетероскедастичности, особенно при неравных n по группам."
        },
        "alternatives": {
            "non_normal": {"test": "kruskal", "reason": "если распределения далеки от нормальных"}
        },
        "effect_size": "eta_squared",
        "emoji": "📈"
    },
    ...
    "kruskal": {
        ...
        "why_it_works": {
            "junior": "Непараметрический аналог ANOVA. Сравнивает ранги вместо средних.",
            "mid": "Проверяет сдвиги распределений между группами по рангам.",
            "senior": "При значимости нужен post‑hoc (например, Dunn) с коррекцией множественных сравнений."
        },
        "effect_size": "epsilon_squared",
        "emoji": "📈"
    },
    ...
    "t_test_rel": {
        ...
        "name_ru": "Парный t‑тест",
        "when_to_use": [
            "2 связанные выборки (до/после, пары)",
            "Числовой исход",
            "Нормальность распределения разностей"
        ],
        "assumptions": ["normality", "independence"],
        "why_it_works": {
            "junior": "Сравнивает среднюю разность в парах и проверяет, отличается ли она от 0.",
            "mid": "Строит t‑статистику по разностям внутри пар.",
            "senior": "Ключевое допущение — нормальность разностей, а не исходов по отдельности."
        },
        "effect_size": "cohens_d",
        "emoji": "🧷"
    },
    ...
    "wilcoxon": {
        ...
        "name_ru": "Тест Уилкоксона (парный)",
        "when_to_use": [
            "2 связанные выборки (до/после, пары)",
            "Ненормальные разности / выбросы",
            "Ordinal или skewed данные"
        ],
        "assumptions": ["independence"],
        "why_it_works": {
            "junior": "Сравнивает знаки и величины разностей по рангам.",
            "mid": "Использует ранги абсолютных разностей и учитывает направление.",
            "senior": "Интерпретация ближе к сдвигу распределения разностей, чем к "
                      "точной разнице средних."
        },
        "emoji": "🧷"
    },
    ...
    "rm_anova": {
        ...
        "when_to_use": [
            "3+ условий/точек у тех же участников",
            "Числовой исход",
            "Хотите сравнить средние по условиям"
        ],
        "assumptions": ["normality", "independence"],
        "why_it_works": {
            "junior": "Сравнивает средние между несколькими условиями у одних и тех же людей.",
            "mid": "Учитывает зависимость измерений внутри субъекта.",
            "senior": "На практике часто лучше LMM при пропусках/небалансе и сложной структуре данных."
        },
        "emoji": "🧵"
    },
    ...
    "friedman": {
        ...
        "assumptions": ["independence"],
        "why_it_works": {
            "junior": "Непараметрический аналог RM‑ANOVA. Сравнивает ранги внутри субъектов.",
            "mid": "Ранжирует значения внутри каждого субъекта и сравнивает суммы рангов по условиям.",
            "senior": "При значимости нужен post‑hoc для пар условий с поправкой на множественность."
        },
        "emoji": "🧵"
    },
    ...
    "fisher_exact": {
        ...
        "when_to_use": [
            "2×2 таблица сопряжённости",
            "Малые ожидаемые частоты",
            "Категориальные данные"
        ],
        "assumptions": ["independence"],
        "why_it_works": {
            "junior": "Проверяет связь в 2×2 таблице, хорошо работает на малых выборках.",
            "mid": "Считает точную вероятность наблюдать такие или более экстремальные частоты при H0.",
            "senior": "Альтернатива χ² при малых expected counts."
        },
    ...
    "fisher": {
        ...
        "assumptions": ["independence"],
        "why_it_works": {
            "junior": "То же, что fisher_exact: точный тест для 2×2 таблиц.",
            "mid": "Используется для малых ожидаемых частот вместо χ².",
            "senior": "В проекте встречается как алиас в UI/шаблонах."
        },
        "effect_size": "odds_ratio",
        "emoji": "🏷️"
    },
    ...
    "mcnemar": {
        ...
        "when_to_use": [
            ...
            "Таблица 2×2 несогласованных пар"
        ],
        "assumptions": ["independence"],
        "why_it_works": {
            "junior": "Проверяет, изменились ли доли между двумя связанными измерениями.",
            "mid": "Смотрит только на несогласованные пары (01 и 10) и тестирует их асимметрию.",
            "senior": "Не путать с χ² для независимых групп: здесь важна связанность наблюдений."
        },
        "emoji": "🧷"
    },
    ...
    "cochran_q": {
        ...
        "name_ru": "Тест Кохрана Q",
        "when_to_use": [
            "3+ связанных измерений",
            "Бинарный исход",
            "Хотите сравнить доли по условиям"
        ],
        "assumptions": ["independence"],
        "why_it_works": {
            "junior": "Расширение Мак‑Немара на 3+ условий у тех же участников.",
            "mid": "Сравнивает доли успеха между условиями с учетом связанности.",
            "senior": "При значимости — post‑hoc попарные сравнения с поправкой."
        },
        "emoji": "🧷"
    },
    ...
    "clustered_correlation": {
        ...
        "when_to_use": [
            "Много числовых переменных",
            "Хотите увидеть группы взаимосвязанных признаков",
            "Нужна тепловая карта с иерархической кластеризацией"
        ],
        "assumptions": [],
        "why_it_works": {
            "junior": "Строит матрицу корреляций и группирует похожие переменные.",
            "mid": "Иерархическая кластеризация упорядочивает признаки, чтобы паттерны были видны.",
            "senior": "Полезно для разведочного анализа, но корреляция ≠ причинность."
        },
        "emoji": "🧊"
    },
    ...
    "linear_regression": {
        ...
        "when_to_use": [
            "Числовой исход",
            "Хотите объяснить/предсказать через 1+ предикторов",
            "Нужна интерпретируемая модель"
        ],
        "assumptions": ["linearity", "homoscedasticity", "independence"],
        "why_it_works": {
            "junior": "Строит линию/плоскость, которая лучше всего описывает зависимость.",
            "mid": "Оценивает коэффициенты, минимизируя сумму квадратов ошибок.",
            "senior": "Важно проверять остатки, выбросы и мультиколлинеарность."
        },
    ...
    "logistic_regression": {
        ...
        "when_to_use": [
            "Бинарный исход",
            "Хотите предсказать вероятность события",
            "Нужна интерпретируемость (odds ratio)"
        ],
        "assumptions": ["independence"],
        "why_it_works": {
            "junior": "Предсказывает вероятность события (0/1) по признакам.",
            "mid": "Моделирует log-odds как линейную комбинацию предикторов.",
            "senior": "Качество оценивают ROC/AUC, калибровкой и анализом ошибок."
        },
        "effect_size": "odds_ratio",
        "emoji": "🎯"
    },
    ...
    "roc_analysis": {
        ...
        "when_to_use": [
            ...
            "Нужно оценить качество модели при разных порогах",
            "Хотите сравнить несколько моделей"
        ],
        "assumptions": [],
        "why_it_works": {
            "junior": "Показывает компромисс между чувствительностью и специфичностью.",
            "mid": "AUC — вероятность, что модель ранжирует случайный positive выше random negative.",
            "senior": "AUC не заменяет калибровку; при дисбалансе классов смотрите PR‑AUC."
        },
        "emoji": "🧪"
    },
    ...
    "mixed_model": {
        ...
        "when_to_use": [
            "Повторные измерения",
            "Кластерные/иерархические данные",
            "Неравный баланс и пропуски по времени"
        ],
        "assumptions": ["independence"],
        "why_it_works": {
            "junior": "Учитывает, что измерения одного пациента похожи между собой.",
            "mid": "Добавляет случайные эффекты (например, random intercept) для субъектов.",
            "senior": "Часто предпочтительнее RM‑ANOVA при пропусках и несбалансированном дизайне."
        },
        "emoji": "🧬"
    },
    ...
    "mixed_effects": {
        ...
        "name_ru": "Смешанные эффекты (LMM)",
        "when_to_use": [
            "Повторные измерения",
            "Нужно учесть внутри‑субъектную корреляцию"
        ],
        "assumptions": ["independence"],
        "why_it_works": {
            "junior": "То же, что mixed_model: LMM для зависимых наблюдений.",
            "mid": "Может включать random intercept и/или random slope.",
            "senior": "В проекте встречается как отдельный method_id."
        },
        "emoji": "🧬"
    },
    ...
    "random_forest": {
        "name": "Random Forest",
        "name_ru": "Случайный лес",
        "when_to_use": [
            "Нужно предсказание",
            "Есть нелинейности и взаимодействия",
            "Нужна устойчивость к шуму"
        ],
        "assumptions": [],
        "why_it_works": {
            "junior": "Объединяет много деревьев решений и усредняет их ответы.",
            "mid": "Bagging снижает дисперсию и переобучение одного дерева.",
            "senior": "Важны валидация, утечки признаков и стабильность метрик."
        },
        "emoji": "🌲"
    },
    ...
    "gradient_boosting": {
        ...
        "when_to_use": [
            "Нужно качество предсказания",
            "Есть сложные нелинейные зависимости",
            "Готовы тюнить параметры"
        ],
        "assumptions": [],
        "why_it_works": {
            "junior": "Добавляет деревья по одному, исправляя ошибки предыдущих.",
            "mid": "Оптимизирует функцию потерь градиентным шагом в пространстве моделей.",
            "senior": "Чувствителен к переобучению: важны learning rate, depth, early stopping (если есть)."
        },
        "emoji": "🔥"
    },
    ...
    "knn": {
        ...
        "name_ru": "k‑ближайших соседей",
        "when_to_use": [
            "Нужно быстрое базовое предсказание",
            "Признаки отмасштабированы",
            "Размер данных умеренный"
        ],
        "assumptions": [],
        "why_it_works": {
            "junior": "Смотрит на ближайшие примеры и голосует/усредняет.",
            "mid": "Качество зависит от метрики расстояния и масштаба признаков.",
            "senior": "Плохо масштабируется по n и чувствителен к шумным признакам без отбора."
        },
        "emoji": "🧭"
    },
    ...
    "svm": {
        ...
        "name_ru": "Метод опорных векторов (SVM)",
        "when_to_use": [
            "Классификация/регрессия",
            "Нужны ядра для нелинейности",
            "Размер данных небольшой/средний"
        ],
        "assumptions": [],
        "why_it_works": {
            "junior": "Ищет разделяющую границу с максимальным зазором.",
            "mid": "Ядра позволяют учесть нелинейности без явного построения признаков.",
            "senior": "Требует нормализации, тюнинга C/γ и аккуратной валидации."
        },
        "emoji": "🧷"
    }
}
