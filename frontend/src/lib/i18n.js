...
const resources = {
  ru: {
    translation: {
      // Common UI
      "analysis": "Анализ",
      "dataset": "Файлы данных",
      "datasets": "Файлы данных",
      "upload_dataset": "Загрузить файл данных",
      ...
      "no_datasets_found": "Файлы данных не найдены",
      "loading_dataset": "Загрузка файла данных…",
      "errors": "Ошибки",
      "unknown": "неизвестно",
      ...
      "compare_2_groups": "Сравнить 2 группы",
      "compare_2_groups_desc": "Тесты для сравнения двух независимых групп",
      "compare_3plus_groups": "Сравнить 3+ групп",
      "compare_3plus_groups_desc": "Тесты для сравнения трех и более независимых групп",
      "paired_repeated": "Парные / повторные",
      "paired_repeated_desc": "Тесты для до/после и повторных измерений",
      ...
      "protocol_builder": "Конструктор протокола",
      "add_test": "Добавить тест",
      "remove_test": "Удалить тест",
      "move_up": "Переместить вверх",
      "move_down": "Переместить вниз",
      "protocol_empty": "Протокол пуст. Добавьте тесты из левой панели.",
      "protocol_empty_hint": "Откройте «Тесты» во вкладке «Данные» и добавьте нужное.",
      "edit": "Редактировать",
      "remove": "Удалить",
      "show_details": "Подробнее",
      "hide_details": "Свернуть",
      "ai_suggest_tests": "ИИ: предложить тесты",
      "executing": "Выполняю…",
      "execute_protocol": "Выполнить",
      ...
      "ai_recommendations_desc": "ИИ анализирует структуру данных и предлагает подходящие тесты.",
      "get_ai_suggestions": "Получить рекомендации",
      "no_suggestions": "Нет доступных рекомендаций",
      "ai_no_recommendations": "Нет рекомендаций для текущих данных и протокола",
      "confidence": "Уверенность",
      "reason": "Причина",
      "add_to_protocol": "Добавить в протокол",
      "added": "Добавлено",
      "ai_suggestion_title": "ИИ предлагает следующий тест:",
      "ai_analyzing": "ИИ анализирует данные...",
      "ai_analyzing_dataset": "ИИ анализирует датасет...",
      "ai_ready": "Рекомендации готовы",
      "ai_error": "Ошибка при получении рекомендаций ИИ",
      "suggested_config": "Предложенная конфигурация",
      "ai_disclaimer": "ИИ даёт рекомендации на основе структуры данных. Проверьте корректность параметров перед запуском.",
      "ai_empty_protocol_hint": "Протокол пуст — ИИ предложит базовые тесты для начала.",
      "ai_error_help_title": "Что проверить",
      "ai_error_help_item_dataset": "Выбран ли файл данных и доступен ли датасет",
      "ai_error_help_item_backend": "Запущен ли backend и доступен ли /api/v1",
      "ai_error_help_item_auth": "Нет ли 401/429 из-за auth или лимитов",
      "ai_error_help_item_format": "Поддерживаются ли форматы данных (CSV/XLSX/Parquet)",
      "ai_check_api": "Проверить доступность API",

      // Analysis Design (JAMOVI style)
      "welcome_to_analysis": "Добро пожаловать в анализ данных",
      "select_dataset_first": "Сначала выберите файл данных",
      ...
      "optional_ai": "Опционально: рекомендации ИИ",
      ...
      "settings_education_junior_label": "Начальный",
      "settings_education_junior_desc": "Коротко и интуитивно",
      "settings_education_mid_label": "Средний",
      "settings_education_mid_desc": "Больше деталей и практических нюансов",
      "settings_education_senior_label": "Продвинутый",
  ...
  en: {
    translation: {
      ...
      "protocol_empty_hint": "Open “Tests” in “Data” and add what you need.",
      "edit": "Edit",
      "remove": "Remove",
      "show_details": "Show details",
      "hide_details": "Hide details",
      "ai_suggest_tests": "AI: suggest tests",
      "executing": "Running…",
      "execute_protocol": "Run",
      ...
      "ai_recommendations_desc": "AI inspects dataset structure and proposes suitable tests.",
      "get_ai_suggestions": "Get suggestions",
      "no_suggestions": "No suggestions available",
      "ai_no_recommendations": "No recommendations for the current data and protocol",
      ...
      "ai_analyzing_dataset": "Analyzing dataset...",
      "ai_ready": "Suggestions ready",
      "ai_error": "Error getting suggestions",
      "suggested_config": "Suggested configuration",
      "ai_disclaimer": "AI recommendations are based on dataset structure. Please verify parameters before running.",
      "ai_empty_protocol_hint": "Protocol is empty — AI will suggest baseline tests.",
      "ai_error_help_title": "What to check",
      "ai_error_help_item_dataset": "Dataset is selected and exists on the server",
      "ai_error_help_item_backend": "Backend is running and /api/v1 is reachable",
      "ai_error_help_item_auth": "No 401/429 due to auth or rate limits",
      "ai_error_help_item_format": "Data format is supported (CSV/XLSX/Parquet)",
      "ai_check_api": "Check API availability",
